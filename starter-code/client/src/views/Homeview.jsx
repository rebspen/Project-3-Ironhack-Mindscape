...
class HomeView extends Component {
  ...
  render() {
    return (
      ...
      <button type="button" className="btn btn-light m-2 p-3 w-60" style={{"minHeight":"10%", border: "2px solid #3043C8", backgroundColor: "#f0f0f2"}}><Link to= "/themes" className='display-4' style={{"color":"#3043C8"}}> <h3>Begin a new journey</h3></Link></button>
